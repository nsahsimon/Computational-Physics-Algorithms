...
v_y(1)=5;        % initialise  theta and omega of Hyperion     
for i= 1:npoints-1;               % loop over the timesteps                
    r_c(i)=sqrt(x(i)^2+y(i)^2);           % Compute new velocities in the x and y directions           
    ...
    %We need to adjust theta after each iteration so as to keep it between %+/-pi for plotting purposes. We do that here   
