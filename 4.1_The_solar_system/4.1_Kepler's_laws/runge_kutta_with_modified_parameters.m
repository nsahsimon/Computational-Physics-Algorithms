...
for step = 1:npoints-1;     
    ...
    radius=sqrt(x^2+y^2);   % Compute Runge Kutta values for the y equations   
    y_dash=y+0.5*v_y*dt; 
    ...
    plot(x_new,y_new,'-k');  
    drawnow;     % Update x and y velocities  with new velocities 
    v_x=v_x_new; 
    v_y=v_y_new; % Update x and y with new positions
    x=x_new; 
    y=y_new;   
end; 